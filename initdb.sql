...
(
    id          serial4      NOT NULL, -- Cột id có kiểu serial4 (tự tăng), không được null.
    "name"      varchar(255) NOT NULL,
    created_at  timestamp(6) NULL,
    updated_at  timestamp(6) NULL,
    description varchar(255) NULL,
...
(
    id            bigserial    NOT NULL, --	Cột id có kiểu bigserial (tự tăng), không được null.
    first_name    varchar(255) NOT NULL,
    last_name     varchar(255) NOT NULL,
    date_of_birth date         NOT NULL,
    "gender" public."e_gender" NOT NULL, -- dung kieu enum o tren
    ...
    CONSTRAINT tbl_user_pkey PRIMARY KEY (id) -- Tạo ràng buộc khóa chính.
);
...
(
    ...
    CONSTRAINT fk_address_to_user FOREIGN KEY (user_id) REFERENCES public.tbl_user (id) -- cot user_id la khoa ngoai lien ket voi cot id cua bang tbl_user
);
