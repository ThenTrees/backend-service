package vn.thentrees.backendservice.config;
...
import vn.thentrees.backendservice.filter.CustomizeRequestFilter;
...
public class AppConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        provider.setUserDetailsService(userDetailService.userDetailService());
