...
import vn.thentrees.backendservice.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
            ...
            @ApiResponse(responseCode = "400", description = "Bad Request",
                    content = {@Content(mediaType = APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(
                                    name = "400 Response",
                                    summary = "Handle exception when the data invalid. (@RequestBody, @RequestParam, @PathVariable)",
                                    value = """
                                            {
    ...
    /**
     * Handle exception when access is forbidden
     *
     * @param e
     * @param request
     * @return
